...
export class ApiService {
   ...
   * @param path API path (e.g., '/pages', '/attachments')
   ...
   * @returns Observable of ContentImprovementResponse
   */
   ...
   * @param spaceKey Space key (optional, uses default if not provided)
   * @param attachmentIds List of attachment IDs (optional)
   * @param parentPageId Parent page ID (optional)
   * @returns Observable of PageResponse
   */
  createPage(
    title: string,
    content: string,
  ...
  /**
   * Publish a page immediately to Confluence
   * @param pageId The ID of the page to publish
   * @returns Observable of PublishResponse
   */
  ...
  /**
   * Schedule a page for later publication
   * @param pageId The ID of the page to schedule
   * @param scheduledAt Optional scheduled time (ISO string). If not provided, uses current time
  ...
  /**
   * Get all schedules
   * @returns Observable of Schedule array
   */
   ...
   * @returns Observable of ConfigResponse
   */
  ...
  /**
   * Generate description for an attachment
   * @param description Optional existing description to improve
   * @returns Observable of AttachmentDescriptionResponse
   */
